...
const ja = {
  ...
  setting: {
    ...
    imageWidth: {
      ...
      description: 'ピクセル単位でエクスポートされる画像の幅を設定します。デフォルトは750pxです。',
    },
    padding: {
      title: '画像の余白',
      description: 'エクスポートされる画像の内側の余白を設定します。すべての辺のデフォルトは24pxです。',
      top: '上の余白',
      right: '右の余白',
      bottom: '下の余白',
      left: '左の余白',
    ...
    split: {
      ...
      overlap: {
        label: '重複パディング',
        description: 'コンテンツが急に切れないように、ページ間の重複パディングを設定します。デフォルトは80pxです。',
      },
    },
    filename: {
