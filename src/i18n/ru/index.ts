...
const ru = {
  ...
  setting: {
    ...
    imageWidth: {
      ...
      description:
        'Установите ширину экспортируемого изображения в пикселях. По умолчанию 750px.',
    },
    split: {
      ...
      overlap: {
        label: 'Перекрытие',
        description:
          'Устанавливает перекрытие между страницами, чтобы избежать резкого обрыва содержимого. По умолчанию 80px.',
      },
    },
    filename: {
